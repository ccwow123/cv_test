...
from utils.utils2 import valTrackbars_Hough,initializeTrackbars_Hough
initializeTrackbars_Hough()
src = cv2.imread(r"test_imgs/2.jpg")
img = src.copy()
...
# 霍夫圆检测
while True:
    thres = valTrackbars_Hough()  # 实例化阈值的滑动条
    circle = cv2.HoughCircles(dst_img, cv2.HOUGH_GRADIENT, 1, thres[4],
                         param1=thres[0], param2=thres[1], minRadius=thres[2], maxRadius=thres[3])

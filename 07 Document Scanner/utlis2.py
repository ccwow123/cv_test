...
def initializeTrackbars(intialTracbarVals=0):
    ...
    cv2.createTrackbar("Th_bin2", "Trackbars", 255, 255, nothing)
    cv2.createTrackbar("Th_canny1", "Trackbars", 1, 255, nothing)
    cv2.createTrackbar("Th_canny2", "Trackbars", 1, 255, nothing)
    cv2.createTrackbar("pengzhang", "Trackbars", 1, 10, nothing)
    cv2.createTrackbar("fushi", "Trackbars", 1, 10, nothing)
    cv2.createTrackbar("maxArea", "Trackbars", 500, 1000, nothing)
    cv2.createTrackbar("epsilon", "Trackbars", 6, 10, nothing)


def valTrackbars():
    Threshold1 = cv2.getTrackbarPos("Th_bin1", "Trackbars")
    Threshold2 = cv2.getTrackbarPos("Th_bin2", "Trackbars")
    Threshold3 = cv2.getTrackbarPos("Th_canny1", "Trackbars")
    Threshold4 = cv2.getTrackbarPos("Th_canny2", "Trackbars")
    Threshold5 = cv2.getTrackbarPos("pengzhang", "Trackbars")
    Threshold6 = cv2.getTrackbarPos("fushi", "Trackbars")
    Threshold7 = cv2.getTrackbarPos("maxArea", "Trackbars")
    Threshold8 = cv2.getTrackbarPos("epsilon", "Trackbars")

    src = Threshold1, Threshold2, Threshold3, Threshold4, Threshold5, Threshold6, Threshold7, Threshold8
    return src

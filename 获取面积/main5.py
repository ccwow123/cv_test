...
优化：
现在需要两张图，以后看看可不可以只用一张图完成，即unet生成的多分类结果
'''
...
if __name__ == '__main__':
    path1 = r'D:\Files\test\Image\origin'  # 电容图片
    ext1 = 'jpg'
    path2 = r'D:\Files\test\Image\mask'  # 缺陷mask图片   注意路径不能有中文
    ext2 = 'png'


    get_target_true_area(path1,path2)
